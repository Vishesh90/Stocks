...
# ─────────────────────────────────────────────────────────────────
NIFTY50_STOCKS = [
    Instrument("RELIANCE",  "Reliance Industries",  AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="RELIANCE.NS",  lot_size=250,  segment="Energy"),
    Instrument("TCS",       "Tata Consultancy",     AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="TCS.NS",       lot_size=150,  segment="IT"),
    Instrument("HDFCBANK",  "HDFC Bank",            AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="HDFCBANK.NS",  lot_size=550,  segment="Banking"),
    Instrument("INFY",      "Infosys",              AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="INFY.NS",      lot_size=400,  segment="IT"),
    Instrument("ICICIBANK", "ICICI Bank",           AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="ICICIBANK.NS", lot_size=700,  segment="Banking"),
    Instrument("HINDUNILVR","Hindustan Unilever",   AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="HINDUNILVR.NS",lot_size=300,  segment="FMCG"),
    Instrument("ITC",       "ITC Ltd",              AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="ITC.NS",       lot_size=1600, segment="FMCG"),
    Instrument("SBIN",      "State Bank of India",  AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="SBIN.NS",      lot_size=1500, segment="Banking"),
    Instrument("BHARTIARTL","Bharti Airtel",        AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="BHARTIARTL.NS",lot_size=500,  segment="Telecom"),
    Instrument("KOTAKBANK", "Kotak Mahindra Bank",  AssetClass.EQUITY, Exchange.NSE, yfinance_ticker="KOTAKBANK.NS", lot_size=400,  segment="Banking"),
